      ...
      <div className="left-inner">
        <div className="info">
          ...
          <div className="social-links">
            <a href={props.instaURL} target="_blank"><i className="fa"><Instagram /></i></a>
            <a href={props.githubURL} target="_blank"><i className="fa"><Github /></i></a>
            <a href={props.linkedinURL}  target="_blank"><i className="fa"><LinkedIn /></i></a>
          </div>
        </div>
      </div>
    </div>
